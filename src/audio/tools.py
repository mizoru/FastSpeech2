...
import src.audio.stft as stft
import src.audio.hparams_audio as hparams
from src.audio.audio_processing import griffin_lim
...
def inv_mel_spec(mel, out_filename=None, griffin_iters=60):
    mel = torch.stack([mel])
